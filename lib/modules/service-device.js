...
/* ------------------------------------------------------------------
* Method: startWiper([, callback])
*
* ---------------------------------------------------------------- */
OnvifServiceDevice.prototype.startWiper = function(callback) {
	let promise = new Promise((resolve, reject) => {

		let soap_body = '';
		soap_body += '<tds:SendAuxiliaryCommand>';
		soap_body += '<tds:AuxiliaryCommand>';
		soap_body += '<tt:Wiper|On />';
		soap_body += '</tds:AuxiliaryCommand>';
		soap_body += '</tds:SendAuxiliaryCommand>';
		let soap = this._createRequestSoap(soap_body);

		mOnvifSoap.requestCommand(this.oxaddr, 'startWiper', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			console.log(error);
			reject(error);
...
*
* ---------------------------------------------------------------- */
OnvifServiceDevice.prototype.startIntermittentWiper = function(callback) {
	let promise = new Promise((resolve, reject) => {

		let soap_body = '';
		soap_body += '<tds:SendAuxiliaryCommand>';
		soap_body += '<tds:AuxiliaryCommand>';
		soap_body += '<tt:IntermediateWiper|On />';
		soap_body += '</tds:AuxiliaryCommand>';
		soap_body += '</tds:SendAuxiliaryCommand>';
		let soap = this._createRequestSoap(soap_body);

		mOnvifSoap.requestCommand(this.oxaddr, 'startIntermittentWiper', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			console.log(error);
			reject(error);
...
/* ------------------------------------------------------------------
* Method: stopWiper([, callback])
*
* ---------------------------------------------------------------- */
OnvifServiceDevice.prototype.stopWiper = function(callback) {
	let promise = new Promise((resolve, reject) => {

		let soap_body = '';
		soap_body += '<tds:SendAuxiliaryCommand>';
		soap_body += '<tds:AuxiliaryCommand>';
		soap_body += '<tt:Wiper|Off />';
		soap_body += '</tds:AuxiliaryCommand>';
		soap_body += '</tds:SendAuxiliaryCommand>';
		let soap = this._createRequestSoap(soap_body);

		mOnvifSoap.requestCommand(this.oxaddr, 'stopWiper', soap).then((result) => {
			resolve(result);
		}).catch((error) => {
			console.log(error);
			reject(error);
